...
<h3>Type Rating Training <span style="font-weight:bold">Course</span></h3>
...
<tr>
<td valign="top" style="font-weight:bold">Typerating Aircraft Type:</td>
<td>
<select name="aircrafttype">
		...
		{
			if($aircraft->name == $class->aircrafttype)
				$sel = 'selected';
			else
				$sel = '';
