...
<tr></tr>
<?php if($class->tratype == 'typerating')
{ ?>
<tr>
<td>Type rating Aircraft:</td><td><?php echo $class->aircrafttype; ?></td>
</tr>
<?php } ?>
<tr>
...
<?php $rankelevelCLASS = RanksData::getRankLevel($class->ranklevel);
   ...
   $rankelevelCLASS = "0";
     ...
     { ?>
<a href="<?php echo SITE_URL; ?>/index.php/FlightAcademy/course_signup/<?php echo $class->id; ?>" class="signupbutton">Sign Up!</a>
     <?php }
