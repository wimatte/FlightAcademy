...
<h3>Exam Critique for <?php echo $exam->traname; ?></h3>
...
added by <?php $mentordetail = PilotData::getPilotData($exam->examiner); echo $mentordetail->firstname; ?> <?php echo $mentordetail->lastname; ?> on <?php echo $exam->exdate; ?>

<br />
<hr />
<br />
<?php echo $exam->critique; ?>
