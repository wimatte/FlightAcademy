...
<br /><br />
<div align="center"><strong>Congratulations you have PASSED the  Exam with <?php echo $exam->correctq ?> correct questions out of <?php echo $setting->questioncount; ?>.</strong><br /><br /> 
